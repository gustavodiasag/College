...
class Q06 {
	...
	public static void main(String[] args) throws Exception {
		...
		for (int i = 0; i < operations; i++) {
			...
			else if (input.equals("R")) stack.remove();
		}
...
class Stack {
	...
	Stack(int size) { this.games = new Game[size]; this.elements = 0; }

	void insert(Game game) { games[elements++] = game; }
	...
	void show() {
		...
		for (int i = 0; i < elements; i++) { System.out.print("[" + i + "] "); this.games[i].print(); }
	}
}
